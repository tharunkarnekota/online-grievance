...
const Allcomplaints = () => {
  ...
  <div className='con2'>
       <Header2 />
            ...
            <center>
                <h3 ><span style={{color:"white"}}>Number of Total Complaints : </span><span style={{color:"red"}}>{numup.length}</span></h3>
                <h3 ><span style={{color:"white"}}>Number of Under processing Complaints : </span><span style={{color:"red"}}>{numup.length - numving.length}</span></h3>
                <h3 ><span style={{color:"white"}}>Number of verifying Complaints : </span><span style={{color:"red"}}>{numving.length - numvfied.length}</span></h3>
                ...
                { x === "1" || y === "1" ?
                    ...
                    <h1 style={{color:"#000000",textAlign:"center"}}><b>-: Students Concerns :-</b></h1>
