        ...
        <div>
            ...
            <section className="container">
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <input className="form-control-lg m-1 border" style={{width:"50%","float":"left" }} type="email"            placeholder="Email Address*"   onChange={changeHandler} value={email} name="email" /><br /><br />
                    <input className="form-control-lg m-1 border" style={{width:"50%","float":"left" }} type="text"             placeholder="mobile*"          onChange={changeHandler} value={mobile} name="mobile" /><br /><br />
                    <input className="form-control-lg m-1 border" style={{width:"50%","float":"left" }} type="password"         placeholder="password*"         onChange={changeHandler} value={password} name="password" /><br /><br />
                    <input className="form-control-lg m-1 border" style={{width:"50%","float":"left" }} type="confirmpassword"  placeholder="confirm password*" onChange={changeHandler} value={confirmpassword} name="confirmpassword" /><br /><br /><br/><br />
